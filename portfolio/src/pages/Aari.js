...
import aari1 from '../images/categories/aari/aari1.jpeg';
import aari2 from '../images/categories/aari/aari2.jpeg';
import aari3 from '../images/categories/aari/aari3.jpeg';
import aari4 from '../images/categories/aari/aari4.jpeg';
import aari5 from '../images/categories/aari/aari5.jpeg';
import "../style.css";
    ...
    return (
        ...
        <div>
            <div style = {{background: "rgb(119, 117, 91)", paddingTop:'30px', paddingBottom:'45px', paddingLeft:'5px', paddingRight:'5px'}}>
              <h2 style={{font:"24px", fontStyle:"normal", fontSize:"20px",fontFamily:"PT Serif Caption",textAlign:"center", color:"white"}}>Kashmiri Aari</h2>
